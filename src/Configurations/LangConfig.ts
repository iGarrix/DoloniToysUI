  ...
  resources: {
    en: {
      translation: {
        ...
        //About us
        "TM DOLONI-TOYS - Factory of children's happiness!": "TM DOLONI-TOYS - Factory of children's happiness!",
        ...
        "TM DOLONI-TOYS - surprises its customers with high quality products, an incredible level of service, proving itself as a proven assistant in a difficult task - creating children's happiness": "TM DOLONI-TOYS - surprises its customers with high quality products, an incredible level of service, proving itself as a proven assistant in a difficult task - creating children's happiness",
    ...
    ua: {
      translation: {
        ...
        //About us
        "TM DOLONI-TOYS - Factory of children's happiness!": "TM DOLONI-TOYS - Фабрика дитячого щастя!",
        ...
        "TM DOLONI-TOYS - surprises its customers with high quality products, an incredible level of service, proving itself as a proven assistant in a difficult task - creating children's happiness": "TM DOLONI-TOYS - дивує своїх клієнтів високою якістю продукції, неймовірним рівнем сервісу, зарекомендувавши себе як перевірений помічник в непростій справі - створенні дитячого щастя",
